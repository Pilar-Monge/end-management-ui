      ...
      <div className="global-orientation-lock">
        ...
        >
          ...
          >
            ...
            <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="phone-icon">
              
              <rect x="45" y="20" width="30" height="50" rx="4" stroke="#69BFB7" strokeWidth="2.5" fill="none"/>
              <circle cx="60" cy="80" r="2" fill="#69BFB7"/>
              
              
              <path d="M 95 15 Q 110 15 110 30" stroke="#69BFB7" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M 105 25 L 110 30 L 100 32" fill="#69BFB7"/>
              
              <path d="M 25 105 Q 10 105 10 90" stroke="#69BFB7" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
