  ...
  return (
    <div className="wm-layout">
      ...
      <div className="wm-map-area relative overflow-hidden">
        <WorldMap dots={dots} lineColor="#69BFB7" onZoneClick={(dot) => {
          const zone = EXPEDITIONS_MAP.find(e => e.end.lat === dot.end.lat && e.end.lng === dot.end.lng);
        ...
        <div className="absolute bottom-2 left-2 z-10 flex flex-col items-start select-none">
          {showLegend && (
            <div className="mb-2 bg-[#040e0e]/95 border border-[#67ACA9]/40 p-2.5 shadow-lg backdrop-blur-md animate-fade-in flex flex-col gap-1.5 min-w-[130px]" style={{ clipPath: "polygon(4px 0%, 100% 0%, calc(100% - 4px) 100%, 0% 100%)" }}>
        ...
        {selectedZone ? (
          <div className="tactical-zone-panel">
            <div className="tactical-zone-header">
              ...
              <button className="tactical-close-btn" onClick={() => setSelectedZone(null)}>✕</button>
            </div>
            
            <p className="tactical-zone-desc">{selectedZone.desc}</p>

            <div className="tactical-stats-grid">
              <div className="tactical-stat"><span>Peligro</span><strong className="text-red-400">{selectedZone.danger}</strong></div>
              <div className="tactical-stat"><span>Clima</span><strong>{selectedZone.climate}</strong></div>
              <div className="tactical-stat"><span>Equipo</span><strong>{selectedZone.team}</strong></div>
              <div className="tactical-stat"><span>Tiempo</span><strong>{selectedZone.time}</strong></div>
            </div>
            ...
            <div className="tactical-actions">
              <Btn variant="primary" style={{ width: '100%' }}>Planificar Expedición</Btn>
              <Btn variant="ghost" style={{ width: '100%' }}>Ver Detalles</Btn>
            </div>
          </div>
        ) : (
          <>
            ...
            <h3 className="wm-sidebar-title" style={{ marginTop: 16 }}>Resumen Rápido</h3>
            <div className="wm-stats">
              <div className="wm-stat-row">
                <span>En Progreso</span>
                <span className="wm-stat-val" style={{ color: "#69BFB7" }}>2</span>
              </div>
              <div className="wm-stat-row">
                <span>Planeadas</span>
                <span className="wm-stat-val" style={{ color: "#67ACA9" }}>1</span>
              </div>
              <div className="wm-stat-row">
                <span>Retrasadas</span>
                <span className="wm-stat-val" style={{ color: "#f59e0b" }}>1</span>
              </div>
              <div className="wm-stat-row">
                <span>Completadas</span>
                <span className="wm-stat-val" style={{ color: "#4ade80" }}>1</span>
              </div>
              <div className="wm-stat-row">
                <span>Perdidas</span>
                <span className="wm-stat-val" style={{ color: "#ef4444" }}>1</span>
              </div>
              <div className="wm-stat-row">
