  ...
  return (
    <main style={{
      ...
      <div style={{
        position: 'absolute',
        inset: 0,
        background: 'radial-gradient(circle at 20% 15%, rgba(139,35,29,.4), transparent 30%), radial-gradient(circle at 78% 6%, rgba(233,211,160,.18), transparent 24%), linear-gradient(115deg, rgba(0,0,0,.48), transparent 42%, rgba(0,0,0,.62))',
      }} />
      ...
      <section className="dossier" style={{
        position: 'relative',
        maxWidth: '1180px',
        margin: '0 auto',
        padding: '20px',
        ...
        <div style={{ marginBottom: '8px', display: 'flex', justifyContent: 'flex-end', paddingRight: '16px' }}>
          <div className="stamp confidential-stamp" style={{
        ...
        <header style={{ marginBottom: '20px', display: 'flex' }}>
          <div className="header-card" style={{
            ...
            <p className="header-eyebrow" style={{
            ...
            <p className="header-subtitle" style={{
              ...
              textTransform: 'uppercase',
              color: '#6b1414',
            }}>Formulario de ingreso a zona segura</p>
          </div>
        </header>
        ...
        <form onSubmit={handleSubmit} style={{
          ...
          display: 'grid',
          gap: '20px',
          gridTemplateColumns: window.innerWidth >= 1024 ? '1fr 305px' : '1fr',
        }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            <fieldset className="file-section animate-rise" style={{
              border: '2px solid rgba(15, 12, 8, 0.95)',
              background: 'rgba(248, 232, 195, 0.62)',
              boxShadow: 'inset 0 0 0 1px rgba(91, 61, 35, 0.2)',
              padding: '16px',
            }}>
              <legend className="section-title" style={{
              ...
              <div style={{
                ...
                {textFields.map((field) => (
                  <label key={field.name} className="field-label" style={{
                    display: 'block',
                    fontFamily: "ui-monospace, 'Courier New', monospace",
                    fontSize: '0.92rem',
                    fontWeight: 900,
                ...
                <div className="field-label" style={{
                  ...
                  textTransform: 'uppercase',
                  color: '#0a0806',
                  gridColumn: window.innerWidth >= 1024 ? 'span 2' : 'auto',
                }}>
                  Fecha de nacimiento
                  <button
                  ...
                  >
                    ...
                    <span className="calendar-icon" style={{
            ...
            <fieldset className="file-section animate-rise-delay" style={{
              border: '2px solid rgba(15, 12, 8, 0.95)',
              background: 'rgba(248, 232, 195, 0.62)',
              boxShadow: 'inset 0 0 0 1px rgba(91, 61, 35, 0.2)',
              padding: '16px',
          ...
          <aside style={{
            ...
            <label className="photo-drop" style={{
              ...
              backgroundImage: 'url("/images/paper-clean.jpg")',
              backgroundSize: 'cover',
              backgroundPosition: 'center',
              backgroundBlendMode: 'multiply',
              boxShadow: '0 10px 22px rgba(30, 18, 10, 0.42), inset 0 0 25px rgba(77, 45, 22, 0.18)',
            ...
            <button
              ...
              style={{
                ...
                textTransform: 'uppercase',
                width: '100%',
                boxShadow: '0 4px 12px rgba(60, 10, 10, 0.4)',
              }}
            >
              Procesar Ingreso
            </button>
            ...
            <p style={{
              ...
              border: '1.5px solid rgba(50, 35, 20, 0.55)',
              color: '#1a1410',
              fontFamily: "ui-monospace, 'Courier New', monospace",
              fontSize: '0.7rem',
              fontStyle: 'italic',
            ...
            {warning && <p style={{
              border: '2px solid #17140f',
              background: 'rgba(216, 195, 151, 0.86)',
              fontFamily: "ui-monospace, 'Courier New', monospace",
              fontSize: '0.75rem',
              fontWeight: 900,
              padding: '0.75rem',
      ...
      {genderOpen && (
        <div
          ...
          style={{
            position: 'fixed',
            inset: 0,
            background: 'radial-gradient(circle at center, rgba(20, 12, 8, 0.55), rgba(8, 4, 2, 0.85))',
        ...
        >
          <div
            ...
            style={{
              ...
              backgroundBlendMode: 'multiply',
              border: '2px solid rgba(15, 12, 8, 0.95)',
              boxShadow: '0 25px 55px rgba(0, 0, 0, 0.7), inset 0 0 25px rgba(77, 45, 22, 0.18)',
              color: '#06050a',
              position: 'relative',
              zIndex: 81,
              padding: '0.6rem',
          ...
          >
            <p style={{
              ...
              borderBottom: '2px solid rgba(15, 12, 8, 0.7)',
              marginBottom: '0.4rem',
              color: '#06050a',
            }}>Seleccionar género</p>
            {genderOptions.map((option) => (
              <button
                ...
                style={{
                  border: 0,
                  background: form.genero === option ? '#5a1414' : 'transparent',
                  color: form.genero === option ? '#f8e9c2' : '#06050a',
                  cursor: 'pointer',
                  display: 'block',
                  fontFamily: "ui-monospace, 'Courier New', monospace",
                  fontWeight: 900,
      ...
      {calendarOpen && (
        ...
        >
          ...
          >
              ...
              <div style={{ display: 'flex', gap: '8px' }}>
                <button
                  ...
                  style={{
                    ...
                    border: '1.5px solid rgba(15, 12, 8, 0.65)',
                    color: '#5a1414',
                    cursor: 'pointer',
                    fontFamily: 'inherit',
                    fontWeight: 900,
            ...
            <div style={{
              ...
              {weekDays.map((day) => (
                <span key={day} style={{
                  ...
                  textAlign: 'center',
                  letterSpacing: '0.08em',
                  borderBottom: '1px solid rgba(15, 12, 8, 0.25)',
                }}>
                  {day}
                </span>
              ))}
              {calendarDays.map((day) => (
                <button
                  ...
                  style={{
                    aspectRatio: '1',
                    background: day.inMonth ? 'rgba(255, 248, 220, 0.55)' : 'transparent',
                    border: day.isSelected ? '2px solid #5a1414' : '1px solid transparent',
                    color: day.inMonth ? '#06050a' : 'rgba(15, 12, 8, 0.32)',
                    cursor: day.inMonth ? 'pointer' : 'default',
                    fontFamily: "ui-monospace, 'Courier New', monospace",
                    fontWeight: day.isSelected ? 900 : 800,
                    fontSize: '0.95rem',
                  }}
                >
                  {day.date.getDate()}
            ...
            <div style={{
              marginTop: '0.7rem',
              borderTop: '1.5px solid rgba(15, 12, 8, 0.45)',
              paddingTop: '0.55rem',
              display: 'flex',
              justifyContent: 'space-between',
              gap: '8px',
              ...
              >
                ...
                <span className="font-mono text-center uppercase tracking-widest text-zinc-700">
                  Subir retrato
                  <small className="mt-2 block text-[10px] tracking-normal">PNG o JPG</small>
                </span>
              )}
              <input
                accept="image/png,image/jpeg"
      ...
      {genderOpen && (
        <div className="modal-backdrop" onClick={() => setGenderOpen(false)}>
          <div
            className="dropdown-panel animate-pop"
            onClick={(event) => event.stopPropagation()}
          >
        ...
        <div className="modal-backdrop" onClick={() => setCalendarOpen(false)}>
          ...
          >
            ...
            <div className="calendar-grid mt-3">
              ...
              {calendarDays.map((day) => (
                <button
                  className={`calendar-day ${day.inMonth ? '' : 'is-muted'} ${
