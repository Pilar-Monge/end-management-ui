  ...
  return (
    <button
      ...
      style={{
        ...
        height: 16,
        borderRadius: 8,
        background: active ? '#D97706' : '#2D2A24',
      ...
      >
        ...
        >
          <div
            ...
            style={{ borderBottom: '1px solid #2D2A24', paddingBottom: 12 }}
          >
            <span
              style={{
                fontFamily: "'Share Tech Mono', monospace",
  ...
  return (
    <text x={cx} y={cy} textAnchor="middle" dominantBaseline="middle">
      ...
      <tspan
        x={cx}
        dy="18"
        style={{ fontFamily: "'Share Tech Mono', monospace", fill: '#8B8070', fontSize: 9 }}
      >
        TOTAL
      </tspan>
    </text>
  ...
  return (
    <div>
      {mode === 'stats' ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
            <Card>
              ...
              <div className="admin-stack-sm">
                {Object.entries(
                  persons.reduce<Record<string, number>>((acc, person) => {
        ...
        <Card>
          <div className="flex items-center gap-3 mb-3 flex-wrap">
            <SectionHeader
              title={`REGISTRO DE POBLACIÓN — ${persons.length} PERSONAS`}
              accent={false}
            />
              ...
              {statuses.map((s) => (
                <button
                  ...
                  style={{
                    fontFamily: "'Share Tech Mono', monospace",
                    fontSize: 9,
                    background: filterStatus === s ? '#D97706' : '#1A1A20',
                    color: filterStatus === s ? '#0A0A0B' : '#8B8070',
          ...
          <div className="admin-table grid gap-px" style={{ background: '#2D2A24' }}>
            <div
              className="admin-table-header grid grid-cols-12 px-3 py-2"
            ...
            {filtered.map((person) => (
              ...
              >
                ...
                <div className="col-span-2">
                  <span
                    style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 11, color: '#8B8070' }}
                  >
                    {person.role}
                  </span>
                </div>
                ...
                <div className="col-span-1">
                  <span
                    style={{ fontFamily: "'Orbitron', monospace", fontSize: 10, color: '#F5F0E8' }}
                  >
                    {person.age}
                  </span>
                </div>
                ...
                <div className="col-span-1 flex gap-1">
                  ...
                  >
                    <Edit2 size={11} style={{ color: '#D97706' }} />
                  </button>
                  <button
                    onClick={(event) => {
                      event.stopPropagation()
      ...
      <Modal
        ...
        title={editMode ? 'EDITAR PERSONA' : 'FICHA INDIVIDUAL'}
      >
        {selected && (
            ...
            {editMode ? (
              <>
                ...
                <div>
                  ...
                  >
                    {['Activo', 'Herido', 'Enfermo', 'Fuera'].map((s) => (
      ...
      {(mode === 'queue' || mode === 'history') && (
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          {[
            ...
            {
              label: 'APROBADAS HOY',
              value: resolved.filter((a) => a.status === 'approved').length,
              color: '#0D9488',
            },
            {
              label: 'RECHAZADAS HOY',
              value: resolved.filter((a) => a.status === 'rejected').length,
              color: '#DC2626',
            },
            ...
            <Card key={label}>
              <div
                ...
                style={{ fontFamily: "'Orbitron', monospace", fontWeight: 900, color }}
              >
                {value}
              </div>
              <div
                className="admin-text-label"
                style={{
                  fontFamily: "'Rajdhani', sans-serif",
                  color: '#8B8070',
                  letterSpacing: '0.1em',
      ...
      {mode === 'queue' && (
        <Card glow="#D97706">
          <div className="flex items-center justify-between mb-3">
            ...
            >
              Modelo: admission-v1 | Precisión: 89%
            </span>
          </div>
          <div
            style={{
          ...
          <div className="admin-stack-md">
            {pending.map((a) => (
              <motion.div
                ...
                style={{
                  background: '#0D0D10',
                  border: `1px solid ${a.score < 50 ? '#DC262655' : '#2D2A24'}`,
                }}
              >
                      ...
                      <div className="flex items-center gap-2">
                        <span
                          style={{
                            ...
                            fontSize: 14,
                            fontWeight: 700,
                            color: a.score < 50 ? '#DC2626' : '#F5F0E8',
                          }}
                        >
                          {a.name}
                        </span>
            ...
            {resolved.map((a) => (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span
                    style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 12, color: '#F5F0E8' }}
                  >
                    {a.name}
                  </span>
                  <span
        ...
        {selected && (
          <div className="admin-stack-lg">
            ...
            >
              ...
              <div
                className="admin-bar h-2 rounded-sm overflow-hidden"
                style={{ background: '#2D2A24' }}
              >
                <div
                  className="admin-bar-fill"
            ...
            <div>
              ...
              <p style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 12, color: '#F5F0E8' }}>
                {selected.reason}
              </p>
            </div>
...
function ViewInventario({ mode }: { mode: InventoryViewMode }) {
  ...
  const handleSaveEdit = () => {
    ...
    setItems((prev) =>
      prev.map((i) =>
        i.id === editing.id ? { ...i, units: editUnits, pct, status: computeStatus(pct) } : i,
      ),
    )
    setEditing(null)
  ...
  const handleAdd = () => {
    ...
    setItems((prev) => [
      ...prev,
      { ...newItem, id, pct, status: computeStatus(pct) } as InventoryItem,
    ])
  ...
  return (
    <div className="admin-stack-lg">
          ...
          {categories.map((cat) => {
            ...
            return (
              <Card key={cat}>
                ...
                <div
                  className="admin-bar h-1 rounded-sm overflow-hidden mt-1"
                  style={{ background: '#2D2A24' }}
                >
                  <div
                    className="admin-bar-fill"
                    style={{ width: `${avgPct}%`, height: '100%', background: invBarColor(avgPct) }}
                  />
                </div>
              </Card>
            )
            ...
            {filtered.map((item) => {
              ...
              return (
                <motion.div
                  ...
                  style={{
                    background: '#0D0D10',
                    border: `1px solid ${item.status === 'CRÍTICO' ? '#DC262644' : '#2D2A24'}`,
                  }}
                >
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button onClick={() => handleDelete(item.id)} className="admin-icon-btn">
                        <Trash2 size={11} style={{ color: '#DC2626' }} />
                      </button>
                    </div>
                  </div>
                  {isEditing ? (
                    ...
                    <div className="flex items-center gap-3">
                      <div
                        className="admin-bar flex-1 h-2 rounded-sm overflow-hidden"
                        style={{ background: '#2D2A24' }}
                      >
                        <motion.div
                          initial={{ width: 0 }}
      ...
      <Modal open={showAdd} onClose={() => setShowAdd(false)} title="AGREGAR ÍTEM AL INVENTARIO">
        <div className="admin-stack-md">
          {[{ label: 'NOMBRE DEL RECURSO', key: 'name' }].map(({ label, key }) => (
            <div key={key}>
              <label
                style={{
                  fontFamily: "'Share Tech Mono', monospace",
          ...
          <div>
            <label
              style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: 9, color: '#8B8070' }}
            >
              CATEGORÍA
            </label>
            <select
              value={newItem.category ?? 'Esencial'}
            ...
            >
              {['Esencial', 'Médico', 'Defensa', 'Energía', 'Bienestar', 'Agricultura'].map((c) => (
          ...
          <div className="grid grid-cols-2 gap-2">
            {[
              ...
              <div key={key}>
                ...
                <input
                  type="number"
                  value={(newItem as any)[key] ?? 0}
                  onChange={(e) =>
                    setNewItem((prev) => ({ ...prev, [key]: Number(e.target.value) }))
                  }
                  className="w-full mt-1 px-3 py-2 rounded-sm outline-none"
                  style={{
                    background: '#0D0D10',
...
function ViewExpediciones({ mode }: { mode: ExpeditionsViewMode }) {
  ...
  const [newExp, setNewExp] = useState<Partial<Expedition>>({
    name: '',
    objective: '',
    sector: '',
    total: 5,
  ...
  const addParticipant = () => {
    ...
    setNewExp((prev) => ({
      ...prev,
      participants: [...(prev.participants ?? []), participantInput.toUpperCase().slice(0, 2)],
    }))
    setParticipantInput('')
  }
  ...
  return (
    <div className="admin-stack-lg">
      ...
      <div className="admin-stack-md">
        {(mode === 'active'
          ? expeditions.filter((e) => e.status !== 'COMPLETADA')
          : mode === 'history'
            ? expeditions.filter((e) => e.status === 'COMPLETADA')
            : expeditions
        ).map((exp) => {
          ...
          return (
            <Card
              ...
              glow={exp.status === 'EN CURSO' ? '#D97706' : ''}
            >
              <div onClick={() => setSelected(exp)}>
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: 9, color: sc }}
                    >
                      DÍA {exp.day}/{exp.total}
                    </span>
                  </div>
                </div>
                <p
                ...
                {exp.total > 0 && (
                  <div className="flex items-center gap-2 mb-3">
                    <div
                      className="admin-bar flex-1 h-1.5 rounded-sm overflow-hidden"
                      style={{ background: '#2D2A24' }}
                    >
                      <motion.div
                        initial={{ width: 0 }}
              ...
              {exp.status !== 'COMPLETADA' && (
                <div className="flex gap-2 mt-3 pt-3" style={{ borderTop: '1px solid #2D2A24' }}>
                  <ActionBtn
                    ...
                    color="#D97706"
                    small
                    onClick={() => handleAdvanceDay(exp.id)}
                  />
                  <ActionBtn
      ...
      >
        <div className="admin-stack-md">
          {[
            ...
            <div key={key}>
              ...
              <input
                ...
                onChange={(e) => setNewExp((prev) => ({ ...prev, [key]: e.target.value }))}
                className="w-full mt-1 px-3 py-2 rounded-sm outline-none"
                style={{
                  background: '#0D0D10',
                  border: '1px solid #2D2A24',
          ...
          <div>
            ...
            <input
              type="number"
              value={newExp.total ?? 5}
              onChange={(e) => setNewExp((prev) => ({ ...prev, total: Number(e.target.value) }))}
              className="w-full mt-1 px-3 py-2 rounded-sm outline-none"
              style={{
                background: '#0D0D10',
                border: '1px solid #2D2A24',
              ...
              {(newExp.participants ?? []).map((p, i) => (
                <button
                  ...
                  onClick={() =>
                    setNewExp((prev) => ({
                      ...prev,
                      participants: prev.participants?.filter((_, j) => j !== i),
                    }))
                  }
...
function ViewIntercamp({ mode }: { mode: IntercampViewMode }) {
  ...
  const handleSend = () => {
    ...
    setRequests((prev) => [
      ...
      {
        id,
        from: 'CAMPAMENTO ALFA',
        text: `→ ${newReq.to}: ${newReq.text}`,
        time: 'ahora',
        status: 'CONFIRMADO',
        urgent: false,
        type: newReq.type as IntercampRequest['type'],
      },
    ])
    setShowSend(false)
    ...
    <div className="admin-stack-lg">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        {[
          ...
          {
            label: 'APROBADAS',
            value: requests.filter((r) => r.status === 'APROBADO').length,
            color: '#0D9488',
          },
          ...
          <div className="admin-stack-sm">
            {pending.map((req) => (
              <motion.div
                ...
                style={{
                  background: '#0D0D10',
                  border: `1px solid ${req.urgent ? '#DC262655' : '#2D2A24'}`,
                }}
              >
      ...
      <Modal
        open={showSend || mode === 'send'}
        onClose={() => setShowSend(false)}
        title="ENVIAR MENSAJE INTER-CAMPAMENTO"
      >
        <div className="admin-stack-md">
          <div>
            <label
            ...
            <select
              value={newReq.to}
              onChange={(e) => setNewReq((prev) => ({ ...prev, to: e.target.value }))}
              className="w-full mt-1 px-3 py-2 rounded-sm outline-none"
              style={{
                background: '#0D0D10',
                border: '1px solid #2D2A24',
          ...
          <div>
            ...
            <select
              value={newReq.type}
              onChange={(e) => setNewReq((prev) => ({ ...prev, type: e.target.value }))}
              className="w-full mt-1 px-3 py-2 rounded-sm outline-none"
              style={{
                background: '#0D0D10',
                border: '1px solid #2D2A24',
          ...
          <div>
            ...
            <textarea
              value={newReq.text}
              onChange={(e) => setNewReq((prev) => ({ ...prev, text: e.target.value }))}
              rows={3}
            ...
            {levels.map((l) => (
              <button
                ...
                style={{
                  fontFamily: "'Share Tech Mono', monospace",
                  fontSize: 9,
                  background: filterLevel === l ? logLevelColor(l) : '#1A1A20',
                  color: filterLevel === l ? '#0A0A0B' : '#8B8070',
                  border: '1px solid #2D2A24',
                }}
              >
                {l}
...
function ViewLogros({ mode }: { mode: LogrosViewMode }) {
  const achievements = [
    ...
    {
      name: 'SIN BAJAS',
      desc: '7 días sin pérdidas de vida',
      unlocked: true,
      pct: 100,
      color: '#F59E0B',
      xp: 300,
    ...
    {
      name: '100 EXPLORACIONES',
      desc: '67/100 completadas',
      unlocked: false,
      pct: 67,
      color: '#0D9488',
      xp: 600,
    ...
    },
    {
      ...
      desc: 'Produce el 50% de alimentos propios',
      unlocked: false,
      pct: 45,
      color: '#EA580C',
      xp: 800,
    ...
    {
      name: 'FORTALEZA',
      desc: 'Resistir 5 ataques sin bajas',
      unlocked: false,
      pct: 60,
      color: '#DC2626',
      xp: 700,
    ...
    {
      name: 'RED DE ALIANZAS',
      desc: '3 campamentos aliados',
      unlocked: false,
      pct: 33,
      color: '#8B8070',
      xp: 500,
    ...
    {
      name: 'INVENTARIO SEGURO',
      desc: 'Todos los recursos sobre 50%',
      unlocked: false,
      pct: 15,
      color: '#F59E0B',
      xp: 400,
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <div className="flex justify-between mb-2">
                ...
                <span
                  style={{ fontFamily: "'Orbitron', monospace", fontSize: 11, color: '#F59E0B' }}
                >
                  {totalXP} / {nextLevelXP} XP
                </span>
              </div>
              <div
                className="admin-bar h-3 rounded-sm overflow-hidden mb-1"
                style={{ background: '#2D2A24' }}
              >
                <motion.div
                  initial={{ width: 0 }}
                ...
                <Card key={ach.name} glow={ach.unlocked ? ach.color : ''}>
                  <div className="flex items-start gap-3">
                    <div
                      ...
                      style={{
                        background: ach.unlocked ? `${ach.color}22` : '#1A1A20',
                        border: `1px solid ${ach.unlocked ? ach.color : '#2D2A24'}`,
                        opacity: ach.unlocked ? 1 : 0.5,
                      }}
                    >
                      <Trophy
                        size={18}
                        style={{ color: ach.unlocked ? ach.color : UI_COLORS.textFaint }}
                      />
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-1">
                        <div className="flex items-center gap-2">
                          <span
                            style={{
                              fontFamily: "'Share Tech Mono', monospace",
                              fontSize: 10,
                              color: ach.unlocked ? ach.color : '#8B8070',
                            }}
                          >
                            {ach.name}
                          </span>
                        ...
                        <span
                          style={{
                            fontFamily: "'Orbitron', monospace",
                            fontSize: 9,
                            color: ach.unlocked ? '#F59E0B' : UI_COLORS.textFaint,
                          }}
                        >
                          +{ach.xp} XP
                        </span>
                      ...
                      <div
                        className="admin-bar h-1 rounded-sm overflow-hidden"
                        style={{ background: '#2D2A24' }}
                      >
                        <motion.div
                          initial={{ width: 0 }}
                          ...
                          style={{
                            height: '100%',
                            background: ach.unlocked ? ach.color : `${ach.color}66`,
                            borderRadius: 2,
                          }}
                        />
                      </div>
    ...
    <div className="admin-stack-lg">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        {[
          ...
          {
            label: 'CRÍTICAS',
            value: notifs.filter((n) => n.level === 'critical').length,
            color: '#DC2626',
          },
          ...
          <Card key={label}>
            <div
              style={{ fontFamily: "'Orbitron', monospace", fontSize: 28, fontWeight: 900, color }}
            >
              {value}
            </div>
            <div
      ...
      <Card>
        <div className="flex items-center gap-3 mb-3 flex-wrap">
            ...
            {levels.map((l) => (
              <button
                ...
                style={{
                  fontFamily: "'Share Tech Mono', monospace",
                  fontSize: 9,
                  background: filter === l ? notifColor(l) : '#1A1A20',
                  color: filter === l ? '#0A0A0B' : '#8B8070',
                  border: '1px solid #2D2A24',
                }}
              >
                {l.toUpperCase()}
          ...
          {unread > 0 && (
            <ActionBtn label="MARCAR TODO LEÍDO" color="#8B8070" onClick={markAllRead} />
          )}
        </div>
        <div
          style={{
        ...
        <div className="admin-stack-sm">
            ...
            {filtered.map((n) => {
              ...
              return (
                <motion.div
                  ...
                  className="p-3 rounded-sm"
                  style={{
                    background: n.read ? '#0D0D10' : '#111114',
                    border: `1px solid ${n.read ? '#2D2A24' : nc + '55'}`,
                    borderLeft: `3px solid ${n.read ? '#2D2A24' : nc}`,
                  }}
                >
                  <div className="flex items-start justify-between gap-2">
                    <div className="flex-1">
          ...
          {filtered.length === 0 && (
            <EmptyState
              ...
              hint="No hay eventos para este filtro"
              icon={Bell}
            />
          )}
        </div>
          ...
          <Card>
            ...
            <div className="admin-stack-md">
              ...
              <div>
                ...
                >
                  DÍA ACTUAL DEL APOCALIPSIS
                </label>
                <input
                  type="number"
                  value={settings.day}
                  onChange={(e) =>
                    setSettings((prev) => ({ ...prev, day: Number(e.target.value) }))
                  }
                  className="w-full mt-1 px-3 py-2 rounded-sm outline-none"
                  style={{
                    background: '#0D0D10',
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSettings((prev) => ({ ...prev, alertThreshold: Number(e.target.value) }))
                  }
                  className="w-full mt-1 px-3 py-2 rounded-sm outline-none"
                  style={{
                    background: '#0D0D10',
        ...
        {[
          ...
          <motion.div key={label} variants={cardVariants}>
            <Card glow={color}>
              ...
              <div
                className="admin-kpi-value"
                style={{ fontFamily: "'Orbitron', monospace", fontWeight: 900, color: '#F5F0E8' }}
              >
                {value}
              </div>
              <div
      ...
      <div className="mb-3">
        <Card glow="#DC2626" className="admin-priority-card">
          ...
          >
            ...
            <p
              className="admin-text-title"
              style={{ fontFamily: "'Rajdhani', sans-serif", color: '#F5F0E8', fontWeight: 600 }}
            >
            ...
            <div className="grid grid-cols-2 gap-x-3 gap-y-1 mt-1">
              {populationData.map((d) => (
                <div key={d.name} className="flex items-center gap-1.5">
                  ...
                  />
                  <span
                    style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 10, color: '#8B8070' }}
                  >
                    {d.name}:{' '}
                  </span>
                  <span
                    style={{ fontFamily: "'Orbitron', monospace", fontSize: 9, color: '#F5F0E8' }}
                  >
                    {d.value}
                  </span>
                </div>
            ...
            <div className="admin-stack-sm">
              {[
                ...
                <div
                  key={module.name}
                  className="p-2 rounded-sm"
                  style={{ background: '#0D0D10', border: `1px solid ${module.color}44` }}
                >
                  <div className="flex items-center justify-between mb-1">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span
                        className="admin-text-micro"
                        style={{ fontFamily: "'Share Tech Mono', monospace", color: '#F5F0E8' }}
                      >
                        {module.name}
                      </span>
                    </div>
                  ...
                  <span
                    ...
                    style={{ fontFamily: "'Rajdhani', sans-serif", color: '#8B8070' }}
                  >
                    {module.note}
                  </span>
                </div>
        ...
        <Card>
          <div className="flex items-center justify-between flex-wrap gap-3">
            <div className="flex items-center gap-2">
              ...
              >
                PRÓXIMO CICLO AUTOMÁTICO — HOY 18:00
              </span>
            </div>
            <div
              style={{
            ...
            <div className="flex gap-2">
              {automations.map((a, i) => (
                <div
                  ...
                  style={{
                    background: '#0D0D10',
                    border: `1px solid ${a.ok ? '#0D948844' : '#EA580C44'}`,
                  }}
                >
                  <span style={{ fontSize: 10, color: a.ok ? '#0D9488' : '#EA580C' }}>
                    {a.ok ? '✓' : '⚠'}
                  </span>
                  <span
                    style={{
...
export default function AdminDashboard() {
  ...
  const renderSection = () => {
    switch (activeNav) {
      case 'POBLACIÓN':
        return <ViewPoblacion mode={populationViewMode} />
      case 'ADMISIONES IA':
        return <ViewAdmisiones mode={admissionsViewMode} />
      case 'INVENTARIO':
        return <ViewInventario mode={inventoryViewMode} />
      case 'EXPEDICIONES':
        return <ViewExpediciones mode={expeditionsViewMode} />
      case 'INTER-CAMPAMENTOS':
        return <ViewIntercamp mode={intercampViewMode} />
      case 'SEGURIDAD / LOGS':
        return <ViewSeguridad mode={securityViewMode} />
      case 'LOGROS':
        return <ViewLogros mode={logrosViewMode} />
      case 'NOTIFICACIONES':
        return <ViewNotificaciones mode={notifsViewMode} />
      case 'CONFIGURACIÓN':
        return <ViewConfiguracion mode={configViewMode} />
      default:
        ...
        <div className="admin-stage">
          ...
          <div className="admin-layout">
            {[
              ...
              <aside
                className="admin-sidebar hidden md:flex flex-col flex-shrink-0"
                style={{
                  width: 250,
                  background: 'transparent',
                  borderRight: '1px solid #2D2A24',
                  zIndex: 1,
                }}
              >
                <div
                  className="admin-logo px-4 py-5 flex flex-col"
                  style={{ borderBottom: '1px solid #2D2A24' }}
                >
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {activeNav === 'INTER-CAMPAMENTOS' && (
                      <Radio size={18} style={{ color: '#D97706' }} />
                    )}
                  ...
                  <span
                    style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 12, color: '#8B8070' }}
                  >
                    Acceso rápido del módulo
                  </span>
                </div>
                ...
                <nav className="admin-nav flex-1 px-3 py-3 overflow-y-auto">
                  {activeNav === 'POBLACIÓN' && (
                    <>
                      <button
                        type="button"
                        className={`admin-nav-button w-full flex items-center gap-2.5 px-3 py-2 mb-2 rounded-sm transition-all cursor-pointer${populationViewMode === 'stats' ? ' admin-nav-button--active' : ''}`}
                        onClick={() => setPopulationViewMode('stats')}
                        style={{ color: populationViewMode === 'stats' ? '#1A0B04' : '#8B8070' }}
                      >
                        <BarChart2 size={14} />
                        <span
                          style={{
                      ...
                      <button
                        type="button"
                        className={`admin-nav-button w-full flex items-center gap-2.5 px-3 py-2 mb-2 rounded-sm transition-all cursor-pointer${populationViewMode === 'users' ? ' admin-nav-button--active' : ''}`}
                        onClick={() => setPopulationViewMode('users')}
                        style={{ color: populationViewMode === 'users' ? '#1A0B04' : '#8B8070' }}
                      >
                        <Users size={14} />
                        <span
                          style={{
                  ...
                  {activeNav === 'ADMISIONES IA' && (
                    <>
                      <button
                        type="button"
                        className={`admin-nav-button w-full flex items-center gap-2.5 px-3 py-2 mb-2 rounded-sm transition-all cursor-pointer${admissionsViewMode === 'queue' ? ' admin-nav-button--active' : ''}`}
                        onClick={() => setAdmissionsViewMode('queue')}
                        style={{ color: admissionsViewMode === 'queue' ? '#1A0B04' : '#8B8070' }}
                      >
                      ...
                      <button
                        type="button"
                        className={`admin-nav-button w-full flex items-center gap-2.5 px-3 py-2 mb-2 rounded-sm transition-all cursor-pointer${admissionsViewMode === 'history' ? ' admin-nav-button--active' : ''}`}
                        onClick={() => setAdmissionsViewMode('history')}
                        style={{ color: admissionsViewMode === 'history' ? '#1A0B04' : '#8B8070' }}
                      >
                        <CheckCircle size={14} />
                        <span
                          style={{
                  ...
                  {activeNav === 'INVENTARIO' && (
                    <>
                      <button
                        type="button"
                        className={`admin-nav-button w-full flex items-center gap-2.5 px-3 py-2 mb-2 rounded-sm transition-all cursor-pointer${inventoryViewMode === 'summary' ? ' admin-nav-button--active' : ''}`}
                        onClick={() => setInventoryViewMode('summary')}
                        style={{ color: inventoryViewMode === 'summary' ? '#1A0B04' : '#8B8070' }}
                      >
                        <BarChart2 size={14} />
                        <span
                          style={{
                      ...
                      <button
                        type="button"
                        className={`admin-nav-button w-full flex items-center gap-2.5 px-3 py-2 mb-2 rounded-sm transition-all cursor-pointer${inventoryViewMode === 'items' ? ' admin-nav-button--active' : ''}`}
                        onClick={() => setInventoryViewMode('items')}
                        style={{ color: inventoryViewMode === 'items' ? '#1A0B04' : '#8B8070' }}
                      >
                        <Package size={14} />
                        <span
                          style={{
                  ...
                  {activeNav === 'EXPEDICIONES' && (
                    <>
                      <button
                        type="button"
                        className={`admin-nav-button w-full flex items-center gap-2.5 px-3 py-2 mb-2 rounded-sm transition-all cursor-pointer${expeditionsViewMode === 'active' ? ' admin-nav-button--active' : ''}`}
                        onClick={() => setExpeditionsViewMode('active')}
                        style={{ color: expeditionsViewMode === 'active' ? '#1A0B04' : '#8B8070' }}
                      >
                        <Activity size={14} />
                        <span
                          style={{
                      ...
                      <button
                        type="button"
                        className={`admin-nav-button w-full flex items-center gap-2.5 px-3 py-2 mb-2 rounded-sm transition-all cursor-pointer${expeditionsViewMode === 'planning' ? ' admin-nav-button--active' : ''}`}
                        onClick={() => setExpeditionsViewMode('planning')}
                        style={{
                          color: expeditionsViewMode === 'planning' ? '#1A0B04' : '#8B8070',
                        }}
                      >
                        <Map size={14} />
                        <span
                      ...
                      <button
                        type="button"
                        className={`admin-nav-button w-full flex items-center gap-2.5 px-3 py-2 mb-2 rounded-sm transition-all cursor-pointer${expeditionsViewMode === 'history' ? ' admin-nav-button--active' : ''}`}
                        onClick={() => setExpeditionsViewMode('history')}
                        style={{ color: expeditionsViewMode === 'history' ? '#1A0B04' : '#8B8070' }}
                      >
                        <Trophy size={14} />
                        <span
                          style={{
                  ...
                  {activeNav === 'INTER-CAMPAMENTOS' && (
                    <>
                      <button
                        type="button"
                        className={`admin-nav-button w-full flex items-center gap-2.5 px-3 py-2 mb-2 rounded-sm transition-all cursor-pointer${intercampViewMode === 'pending' ? ' admin-nav-button--active' : ''}`}
                        onClick={() => setIntercampViewMode('pending')}
                        style={{ color: intercampViewMode === 'pending' ? '#1A0B04' : '#8B8070' }}
                      >
                        <AlertTriangle size={14} />
                        <span
                          style={{
                      ...
                      <button
                        type="button"
                        className={`admin-nav-button w-full flex items-center gap-2.5 px-3 py-2 mb-2 rounded-sm transition-all cursor-pointer${intercampViewMode === 'history' ? ' admin-nav-button--active' : ''}`}
                        onClick={() => setIntercampViewMode('history')}
                        style={{ color: intercampViewMode === 'history' ? '#1A0B04' : '#8B8070' }}
                      >
                        <Radio size={14} />
                        <span
                          style={{
                      ...
                      <button
                        type="button"
                        className={`admin-nav-button w-full flex items-center gap-2.5 px-3 py-2 mb-2 rounded-sm transition-all cursor-pointer${intercampViewMode === 'send' ? ' admin-nav-button--active' : ''}`}
                        onClick={() => setIntercampViewMode('send')}
                        style={{ color: intercampViewMode === 'send' ? '#1A0B04' : '#8B8070' }}
                      >
                        <Bell size={14} />
                        <span
                          style={{
                  ...
                  {activeNav === 'SEGURIDAD / LOGS' && (
                    <>
                      <button
                        type="button"
                        className={`admin-nav-button w-full flex items-center gap-2.5 px-3 py-2 mb-2 rounded-sm transition-all cursor-pointer${securityViewMode === 'live' ? ' admin-nav-button--active' : ''}`}
                        onClick={() => setSecurityViewMode('live')}
                        style={{ color: securityViewMode === 'live' ? '#1A0B04' : '#8B8070' }}
                      >
                        <Activity size={14} />
                        <span
                          style={{
                      ...
                      <button
                        type="button"
                        className={`admin-nav-button w-full flex items-center gap-2.5 px-3 py-2 mb-2 rounded-sm transition-all cursor-pointer${securityViewMode === 'errors' ? ' admin-nav-button--active' : ''}`}
                        onClick={() => setSecurityViewMode('errors')}
                        style={{ color: securityViewMode === 'errors' ? '#1A0B04' : '#8B8070' }}
                      >
                        <AlertTriangle size={14} />
                        <span
                          style={{
                      ...
                      <button
                        type="button"
                        className={`admin-nav-button w-full flex items-center gap-2.5 px-3 py-2 mb-2 rounded-sm transition-all cursor-pointer${securityViewMode === 'system' ? ' admin-nav-button--active' : ''}`}
                        onClick={() => setSecurityViewMode('system')}
                        style={{ color: securityViewMode === 'system' ? '#1A0B04' : '#8B8070' }}
                      >
                        <Cpu size={14} />
                        <span
                          style={{
                  ...
                  {activeNav === 'LOGROS' && (
                    <>
                      <button
                        type="button"
                        className={`admin-nav-button w-full flex items-center gap-2.5 px-3 py-2 mb-2 rounded-sm transition-all cursor-pointer${logrosViewMode === 'overview' ? ' admin-nav-button--active' : ''}`}
                        onClick={() => setLogrosViewMode('overview')}
                        style={{ color: logrosViewMode === 'overview' ? '#1A0B04' : '#8B8070' }}
                      >
                        <Trophy size={14} />
                        <span
                          style={{
                      ...
                      <button
                        type="button"
                        className={`admin-nav-button w-full flex items-center gap-2.5 px-3 py-2 mb-2 rounded-sm transition-all cursor-pointer${logrosViewMode === 'progress' ? ' admin-nav-button--active' : ''}`}
                        onClick={() => setLogrosViewMode('progress')}
                        style={{ color: logrosViewMode === 'progress' ? '#1A0B04' : '#8B8070' }}
                      >
                        <BarChart2 size={14} />
                        <span
                          style={{
                  ...
                  {activeNav === 'NOTIFICACIONES' && (
                    <>
                      <button
                        type="button"
                        className={`admin-nav-button w-full flex items-center gap-2.5 px-3 py-2 mb-2 rounded-sm transition-all cursor-pointer${notifsViewMode === 'all' ? ' admin-nav-button--active' : ''}`}
                        onClick={() => setNotifsViewMode('all')}
                        style={{ color: notifsViewMode === 'all' ? '#1A0B04' : '#8B8070' }}
                      >
                        <Bell size={14} />
                        <span
                          style={{
                      ...
                      <button
                        type="button"
                        className={`admin-nav-button w-full flex items-center gap-2.5 px-3 py-2 mb-2 rounded-sm transition-all cursor-pointer${notifsViewMode === 'unread' ? ' admin-nav-button--active' : ''}`}
                        onClick={() => setNotifsViewMode('unread')}
                        style={{ color: notifsViewMode === 'unread' ? '#1A0B04' : '#8B8070' }}
                      >
                        <CheckCircle size={14} />
                        <span
                          style={{
                      ...
                      <button
                        type="button"
                        className={`admin-nav-button w-full flex items-center gap-2.5 px-3 py-2 mb-2 rounded-sm transition-all cursor-pointer${notifsViewMode === 'critical' ? ' admin-nav-button--active' : ''}`}
                        onClick={() => setNotifsViewMode('critical')}
                        style={{ color: notifsViewMode === 'critical' ? '#1A0B04' : '#8B8070' }}
                      >
                        <AlertTriangle size={14} />
                        <span
                          style={{
                  ...
                  {activeNav === 'CONFIGURACIÓN' && (
                    <>
                      <button
                        type="button"
                        className={`admin-nav-button w-full flex items-center gap-2.5 px-3 py-2 mb-2 rounded-sm transition-all cursor-pointer${configViewMode === 'camp' ? ' admin-nav-button--active' : ''}`}
                        onClick={() => setConfigViewMode('camp')}
                        style={{ color: configViewMode === 'camp' ? '#1A0B04' : '#8B8070' }}
                      >
                        <Users size={14} />
                        <span
                          style={{
                      ...
                      <button
                        type="button"
                        className={`admin-nav-button w-full flex items-center gap-2.5 px-3 py-2 mb-2 rounded-sm transition-all cursor-pointer${configViewMode === 'system' ? ' admin-nav-button--active' : ''}`}
                        onClick={() => setConfigViewMode('system')}
                        style={{ color: configViewMode === 'system' ? '#1A0B04' : '#8B8070' }}
                      >
                        <Settings size={14} />
                        <span
                          style={{
                ...
                <div className="px-3 py-3" style={{ borderTop: '1px solid #2D2A24' }}>
                  <div
                    className="admin-clock px-2 py-1 rounded-sm"
                    style={{ background: '#111114', border: '1px solid #2D2A24' }}
                  >
                    <span
                      style={{
                        fontFamily: "'Orbitron', monospace",
                  ...
                  <div className="mt-2">
                    ...
                    >
                      Si tocas este módulo otra vez vuelves al Centro de Mando
                    </span>
                  </div>
                </div>
              </aside>
            ...
            >
              {/* Header */}
              <header
                className="admin-header scanlines relative flex-shrink-0 flex items-center justify-between px-5"
              ...
              >
                ...
                <div className="admin-profile flex items-center gap-2 relative z-10">
                  <button
                    ...
                    className="admin-icon-btn relative p-1.5 rounded-sm"
                    style={{ background: '#1A1A20', border: '1px solid #2D2A24' }}
                  >
                    <Bell size={14} style={{ color: '#D97706' }} />
                    {unreadNotifs > 0 && (
                      <span
                        className="absolute -top-1 -right-1 flex items-center justify-center w-3.5 h-3.5 rounded-sm"
                        style={{
                          background: '#DC2626',
                          fontFamily: "'Share Tech Mono', monospace",
                          fontSize: 9,
                  ...
                  <button
                    onClick={() => setActiveNav('CONFIGURACIÓN')}
                    className="admin-icon-btn flex items-center gap-1.5 px-2 py-1 rounded-sm"
                    style={{ background: '#1A1A20', border: '1px solid #2D2A24' }}
                  >
                    <div
