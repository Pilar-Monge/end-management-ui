              ...
              >
                <button
                  ...
                  className={`text-2xl md:text-3xl font-bold tracking-wider transition-colors duration-200 menu-item menu-brush ${
                    active === item ? 'text-white menu-brush-active-blue' : 'text-white'
                  }`}
                >
                  <span className="relative z-[2] inline-flex items-center gap-3">
                    {labels[item]}
                    {item === 'intro' && <span className="text-white arrow-pulse">▶</span>}
                  </span>
                </button>
              </li>
            )
          ...
          <div className="fixed inset-0 z-[100] pointer-events-none">
            ...
            >
              ...
              <div className="relative z-10 mb-4">
                <div
                  className="text-[14px] font-black text-white italic tracking-[0.2em] opacity-90 uppercase"
                  style={{ fontFamily: "'Oswald', sans-serif" }}
                >
                  CREADORES:
                </div>
              ...
              <div className="credits-list relative z-10 space-y-2">
                {TEAM_MEMBERS.map((member) => (
                  <a
                    ...
                    style={{ fontFamily: "'Oswald', sans-serif" }}
                  >
                    <span className="relative z-10 font-bold tracking-wide text-white uppercase">
                      {member.name}
                    </span>
